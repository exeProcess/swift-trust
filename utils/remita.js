...
exports.getVendingProducts = async (payload) => {
  ...
  try{
    const getVendingProductResponse = await axios.get(`https://api-demo.systemspecsng.com/services/connect-gateway/api/v1/vending/products?page=0&pageSize=20&countryCode=${countryCode}&categoryCode=${categoryCode}&provider=${provider}`,{
      headers: {
        'Content-Type': 'application/json',
